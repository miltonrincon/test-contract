...
async function main() {
	...
	const contract = await contractFactory.deploy("TestContract", "T9", "0xD3c30CAD88f5572C861e2e8244Bec49223cf625a", "ipfs://test/", "https://not.revealed.test/"); // instance of the contract
